# Generated by Django 2.0.2 on 2018-02-26 11:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0002_auto_20180225_2007'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='product',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=1, default=Decimal('0.0'), default_currency='USD', max_digits=10),
        ),
        migrations.AddField(
            model_name='product',
            name='price_currency',
